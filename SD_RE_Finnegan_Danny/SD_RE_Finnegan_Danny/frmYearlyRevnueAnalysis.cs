...
{
    public partial class frmYearlyRevnueAnalysis : Form
    {
        public frmYearlyRevnueAnalysis(frmAdminMenu frmAdminMenu)
        {
            InitializeComponent();
        }
        ...
        private void frmYearlyRevnueAnalysis_Load(object sender, EventArgs e)
        {
